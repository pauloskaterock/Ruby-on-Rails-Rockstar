...
class ListMoviesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_movie" do
    assert_difference("ListMovie.count") do
      post list_movies_url, params: { list_movie: { description: @list_movie.description, text: @list_movie.text, title: @list_movie.title } }
    end
  ...
  test "should update list_movie" do
    patch list_movie_url(@list_movie), params: { list_movie: { description: @list_movie.description, text: @list_movie.text, title: @list_movie.title } }
